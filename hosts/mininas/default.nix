...

{
  imports =
    [ # Include the results of the hardware scan.
      ...
      # ... any other modules you want to add
    ];
  ...
  users.users.peter = {
    ...
    # IMPORTANT: Add your SSH Public Key from your laptop here
    openssh.authorizedKeys.keys = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIMC8ctUJZkP0BdyRj5Ny+uWGlU9LNWoLEY0ogLZvERwn ptraenkle@protonmail.ch" 
    ];
  };
